#include "headers/hashmap_base.h"
...
static void hashmap_rehash(hashmap *map) {
    size_t old_size;
    size_t i;
    struct hashmap_element *temp = (struct hashmap_element*)calloc(2 * map->alloced, sizeof(struct hashmap_element));
...
hashmap *hashmap_new(void) {
	...
	map->data = (struct hashmap_element*)calloc(hashmap_init_capacity, sizeof(struct hashmap_element));
